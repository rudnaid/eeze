	...
	return (
		<>
			<div>
				<section
					id="hero"
					className="bg-[url(/hero-bg-image.png)] bg-no-repeat bg-cover bg-center h-200"
				>
					{/* Hero container */}
				...
				<section id="about" className="bg-white py-16 px-6 md:px-12 text-center">
					<div className="max-w-4xl mx-auto">
						<h2 className="text-4xl font-bold text-[#fdc57b] mb-6">About Eeze</h2>
						<p className="text-lg text-gray-700 leading-relaxed">
							We believe that financial tracking should be simple, stress-free, and even a little fun! 
							<b> Eeze </b> is designed to help you manage your money effortlessly. Whether you're tracking expenses, organizing your income, or analyzing your financial habits with interactive charts, we’ve got you covered.
						</p>
						<p className="mt-4 text-lg text-gray-700">
							Our goal is to give you the insights you need to make smarter financial decisions—so you can 
							spend less time worrying about money and more time enjoying life. Let’s take control of your finances together!
						</p>
					</div>
				</section>
			</div>
